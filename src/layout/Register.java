		...
		String w_date = request.getParameter("w_date");
	     ...
	     PreparedStatement pstatement = null;
	          ...
	          int insertQuery4 = 0;
	              ...
	              String queryString = ("insert into customer(email, groom_name, bride_name, contact_person, w_date, booking_date) VALUES (?, ?, ?, ?,cast(w_date as DATETIME), CURDATE())");
	             ...
	             // pstatement.setString(5, cast(w_date as DATETIME));
			...
			if (rs != null && rs.next()) {
				...
				if (insertQuery3 != 0 ) {
					...
					//String query5 = ("select max(wc_id) from wedding")
					}
